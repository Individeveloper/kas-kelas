                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <div class="flex items-center">
                        <div class="p-3 rounded-md bg-blue-100 text-blue-600 ">
                            <i class="fas fa-users text-xl flex align-items-center justify-content-center"></i>
                        </div>
                        <div class="ml-4">
                            <p class="text-sm text-gray-500">Total Murid</p>
                            <p class="text-xl font-bold text-gray-800"><?= $totalMurid ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white shadow p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-xl font-bold text-gray-800 line-clamp-1"><?= formatRupiah($kasMasuk) ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white shadow p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-xl font-bold text-gray-800 line-clamp-1"><?= formatRupiah($kasKeluar) ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white shadow p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-xl font-bold text-gray-800 line-clamp-1"><?= formatRupiah($saldo) ?></p>
                        </div>
                    </div>
                </div>
            </div>
